...
if test.json().get('errorMessage') == 'NOT_AUTHORIZED':
   print(f'{colorama.Fore.RED}{colorama.Style.BRIGHT}!{colorama.Style.RESET_ALL} Invalid Session Name Or Password')
    ...
    while True:
          os.system('clear || cls')
          print(f'{colorama.Fore.YELLOW}1{colorama.Style.RESET_ALL}{colorama.Fore.GREEN} Scrape Student IDs & Student Names')
          print(f'{colorama.Fore.YELLOW}2{colorama.Style.RESET_ALL}{colorama.Fore.GREEN} Set All Students Ready{colorama.Style.RESET_ALL}')
          x = input('\n> ')
